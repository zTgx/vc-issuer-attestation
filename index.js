...
var vc = {
    ...
    "proof": {
        ...
        "proofValue": "da6bb5c68766f1718afb4755e81edc92b0fe2bef7b39c268a0ae164aefe46927a77ea3261d4dd97873339bd311a86b5856af059de61e2f2e816a2374dfb81b0a",
...
var enclaveRegistry = {
    ...
    'sgxMetadata': {
        ...
        'quoteSig': '',
        'quoteCert': ''
    }
};
/**
...
function checkIssuerAttestation() {
    ...
    var mrEnclaveFromVc = '0x' + Buffer.from(bs58.decode(vc.issuer.mrenclave)).toString('hex');
    console.log('   [IssuerAttestation] mrEnclaveFromVc: ', mrEnclaveFromVc);
    // Fetch mrEnclave from parachain
    var mrEnclaveFromParachain = enclaveRegistry.mrEnclave;
    ...
    var sgxMetadata = enclaveRegistry.sgxMetadata;
    if (sgxMetadata != null) {
        var quoteFromData = sgxMetadata.quote;
        console.log('   [IssuerAttestation] quoteFromData: ', quoteFromData);
        var quote = JSON.parse(js_base64_1.Base64.decode(quoteFromData));
        // >>>1. Verify quote status (mandatory field)
        var status_1 = quote['isvEnclaveQuoteStatus'];
        console.log('   [IssuerAttestation] ISV Enclave Quote Status: ', status_1);
        switch (status_1) {
            case "OK":
                console.log("OK!");
                break;
            ...
            default: {
                console.log("   [IssuerAttestation] Unexpected status in attestation report: ", status_1);
                break;
            }
        }
        // >>>2. Verify quote body
        var quoteBody = quote['isvEnclaveQuoteBody'];
        ...
        if (quote['timestamp'] !== undefined) {
            var timestamp = Date.parse(quote['timestamp']);
            var now = Date.now();
    ...
    console.log('   [IssuerAttestation] check passed.xxx');
}
